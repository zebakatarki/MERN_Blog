...
export default function UpdatePosts() {
  ...
  return <div className='p-3 max-w-3xl mx-auto min-h-screen'>
      ...
      <form className='flex flex-col gap-4' onSubmit={handleSubmit}>
        ...
        <div className="flex gap-4 items-center justify-between border-4 border-teal-500 border-1 p-3 wid">
        ...
        <ReactQuill theme='snow' placeholder='write something......' className='h-72 mb-12' value={formData.content} required
        onChange={(value) => {
